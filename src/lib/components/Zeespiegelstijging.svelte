...
<svg id="svg_zeespiegel_chart">
  ...
  <Line data={dataHistoric} color='black' variable='Stijging' legendText='Gemeten stijging' xScale={xScale} yScale={yScale} className='gemeten_zeespiegel' />

  <path d='M50,163 l0,32' stroke='black' fill='none' stroke-width='0.8' stroke-dasharray="5,2"/>
